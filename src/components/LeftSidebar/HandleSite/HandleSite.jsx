    ...
    return (
        <div className="manrope-font">
            ...
            <div className='relative w-full'>
                ...
                <input type="text" className='w-full outline-0 border-b border-solid border-green-main pr-10 gray-true-800' />
            ...
            <div>
                <div className='mt-4 mb-3 px-3 w-full text-[10px] flex justify-between items-center'>
                    ...
                    <div>
                        <span>Sort:</span>
                        <select className='outline-0 text-gray-true-800 outline-0' name="" id="">
