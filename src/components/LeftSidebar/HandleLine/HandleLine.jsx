...
const HandleLine=() => {
    return (
        <div className="manrope-font rendered-height pb-8">
            <Searchbar />
            ...
            {renderedListItem}
            <div className=' w-[100px] absolute bottom-4 flex justify-center items-center tree-detail-button translate-x-1/2 right-1/2'>
                ...
                <span className='ml-2 bg-white z-50 text-[10px] text-dark-main cursor-pointer'>Load more</span> 
            </div>
